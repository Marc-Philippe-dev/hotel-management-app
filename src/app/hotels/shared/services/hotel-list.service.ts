...
export class HotelListService {
  ...
  public hotelsWithCategories$ = combineLatest([
    this.getHotels(), this.getCategories()
  ]).pipe(
  ...
  private hotelInsertedSubject: Subject<IHotel> = new Subject();
  public hotelInserted$ = this.hotelInsertedSubject.asObservable();

  public updatedHotels$ = merge(this.hotelsWithCategories$, this.hotelInserted$).pipe(
